...
Future<void> checkAndDownloadSDK(String location) async {
  ...
  if (!exists) {
    await downloadFile(
        Uri.parse('https://www.dropbox.com/scl/fi/8mg58889wnfy9kgsc2ecu/MobileRTC?rlkey=5jk6k3rhwxsppg5reklwmtm4z&dl=0'),
        iosSDKFile);
  }
  ...
  if (!exists) {
    await downloadFile(
        Uri.parse('https://www.dropbox.com/scl/fi/jmnt54rnst0ppohssntz0/MobileRTCSimulate?rlkey=ap5m9g68oa9kv6qu4zrmbnx7t&dl=0'),
        iosSimulateSDKFile);
  }
  ...
  if (!exists) {
    await downloadFile(
        Uri.parse(
            'https://www.dropbox.com/scl/fi/a1o5495n34vxkyyp6lhq6/commonlib.aar?rlkey=dczrer8c1r5mtk2con78s8q7i&dl=0'),
  ...
  if (!exists) {
    await downloadFile(
        Uri.parse(
            'https://www.dropbox.com/scl/fi/s6fbt4q1iu0u3taolfl29/mobilertc.aar?rlkey=dxe1b4u21rs358ynjkap53qcz&dl=0'),
        androidRTCLibFile);
  }
}
